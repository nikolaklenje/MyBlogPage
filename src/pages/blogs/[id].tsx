  ...
  return (
    <div className="text-white flex flex-col  animate__animated animate__fadeIn animate__delay-1s sm: p-12 lg:p-36 items-left">
      ...
      <p>
        ...
        Section 1.10.32 of de Finibus Bonorum et written by Cicero in 45 BC Sed
        ...
        voluptas nulla 1914 translation by H. Rackhamut I must explain to you
        ...
        pain that produces no resultant Section 1.10.33 of Finibus Bonorum et ,
        written by Cicero in 45vero eos et accusamus et iusto odio dignissimos
