...
export const Contact: FC = () => {
  ...
  return (
    <div className="flex flex-col w-2/3 items-center mt-48">
      {isSuccess ? (
        <div className="container my-24 mx-auto md:px-6 text-center animate__animated animate__bounceIn ">
          <h1 className="text-6xl font-semibold text-white mt-6">Success!!!</h1>
          <p className="text-[#ccd6f6] leading-normal mt-6 w-auto">
            I will be reaching out to you soon. You can find me on Social
            networks too.
          </p>
        </div>
      ) : (
        <>
          {" "}
          <h1 className="text-6xl font-semibold text-white mt-6">
            Get In Touch
          </h1>
