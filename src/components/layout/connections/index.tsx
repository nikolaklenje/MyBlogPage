...
export const Connections: FC = () => {
  return (
    <div>
      <div className="sm: fixed bottom-0 left-2 z-50">
        <div className="relative h-full w-full flex-col">
          <ul className="animate__animated animate__fadeIn animate__delay-1s">
            <Link href={'https://twitter.com/nikolaelite'} target="_blank">
              <li>
                <svg className="svg-icon hover:text-[#64ffda]" viewBox="0 0 20 20">
            ...
            <Link href={'https://www.facebook.com/nikoladelije/'} target="_blank">
              <li>
            ...
            <Link href={'https://www.instagram.com/nikola_stankovic_miami/'} target="_blank">
              <li>
                <svg className="svg-icon" viewBox="0 0 20 20">
            ...
            <Link href={'https://www.linkedin.com/in/nikola-stankovic-00a726236/'} target="_blank">
              <li>
                <svg className="svg-icon" viewBox="0 0 20 20">
          ...
          <div className="mt-4 ml-3 h-32 w-[2px] bg-[#ccd6f6]"></div>
        </div>
      </div>
